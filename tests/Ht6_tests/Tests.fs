    ...
    let readMatrixesTests =
        testList "Tests for readMatrix function"
            ...
            testCase "Reading empty file" <| fun _ ->
                    let subject = Ht6.readMatrix "C:/Users/Admin/MyTask/tests/Ht6_tests/anotherTest.txt"
            ...
            testCase "Reading some file" <| fun _ ->
                    let subject = Ht6.readMatrix("C:/Users/Admin/MyTask/tests/Ht6_tests/someTest.txt")
