...
[<assembly: AssemblyTitleAttribute("Ht4Tests")>]
[<assembly: AssemblyProductAttribute("Hometask4")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Ht4Tests"
    let [<Literal>] AssemblyProduct = "Hometask4"
