...
[<assembly: AssemblyTitleAttribute("MyTask.Tests")>]
[<assembly: AssemblyProductAttribute("MyTask")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MyTask.Tests"
    let [<Literal>] AssemblyProduct = "MyTask"
